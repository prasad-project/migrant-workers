...
export default function DoctorDashboard() {
  ...
  const [patientData, setPatientData] = useState<Worker | null>(null)
  ...
  const searchPatient = async () => {
    ...
    try {
      ...
      const patient = workers.find(worker =>
        worker.healthId.toLowerCase().includes(searchHealthId.toLowerCase()) ||
        searchHealthId.toLowerCase().includes(worker.healthId.toLowerCase())
      )

      if (patient) {
        setPatientData(patient)
      } else {
        setSearchError("No record found for this Health ID")
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="container mx-auto px-6 py-6 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex gap-4">
              <Input
                placeholder="Enter Health ID (e.g., 91-2847-5639-1234)..."
                className="flex-1"
            ...
            <div className="flex gap-4 text-sm text-gray-600">
              ...
              <button className="text-blue-600 hover:underline">Health ID</button>
              <button className="text-blue-600 hover:underline">ABHA Number</button>
              <button className="text-blue-600 hover:underline">Phone Number</button>
            </div>
          </CardContent>
        </Card>
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-medium">{patientData.bloodGroup}</div>
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4 text-sm">
                    <div>
                      ...
                      <div className="font-medium text-blue-600">{patientData.healthId}</div>
                    </div>
                    <div>
                      <span className="text-gray-500">Phone</span>
                      <div className="font-medium text-green-600">{patientData.phone}</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Health History Card - Dynamic */}
        {patientData && patientData.healthHistory && (
          <div className="bg-white shadow-md rounded-2xl p-5 border">
            <h2 className="text-xl font-semibold text-gray-800 mb-3 flex items-center">
              🩺 Health History
            </h2>
            <div className="space-y-2 text-gray-700">
              <p><span className="font-medium">Vaccinations:</span> {patientData.healthHistory.vaccinations.join(', ')}</p>
              ...
              <p><span className="font-medium">Medications:</span> {patientData.healthHistory.medications.length > 0 ? patientData.healthHistory.medications.join(', ') : 'None'}</p>
            </div>
          </div>
        )}
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Card className="p-4 bg-green-50 border-green-200">
                    ...
                    <div className="text-xs text-gray-500">Total prescriptions</
